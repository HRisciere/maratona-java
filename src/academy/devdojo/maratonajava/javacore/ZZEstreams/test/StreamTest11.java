...
public class StreamTest11 {
    ...
    public static void main(String[] args) {
        ...
        // Não é boa prática utilizar Collectors da maneira abaixo, o código não fica com boa aparência e tem a questão da performance
        // Fazendo o mesmo utilizando
        // collect tem uma grande opção de método para utilizar, como supplier, Biconsumer, accumulator...
        // Quando começa a usar Collectors a legibilidade do código fica um pouco afetada
        System.out.println(lightNovels.stream().collect(Collectors.counting()));

        lightNovels.stream().max(Comparator.comparing(LightNovel::getPrice)).ifPresent(System.out::println);
        // Fazendo o mesmo utilizando Collectors
        lightNovels.stream().collect(Collectors.maxBy(Comparator.comparing(LightNovel::getPrice))).ifPresent(System.out::println);
        // mapToDouble para evitar o autoboxing e o unboxing
